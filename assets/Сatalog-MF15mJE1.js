...
`;function pe({onLoadMore:e}){return v.jsx(qe,{onClick:e,children:"Load more"})}pe.propTypes={onLoadMore:c.func.isRequired};function me({data:e}){const{img:t,make:o,mileage:s,model:u,type:l,year:n,rentalPrice:r,address:C,rentalCompany:T,functionalities:y}=e,f=C.split(","),R=f[1].trim(),i=f[2]?f[2].trim():"",p=y[0];return v.jsxs(Ie,{children:[v.jsx(je,{}),v.jsxs("div",{children:[v.jsx(_e,{children:t?v.jsx("img",{src:t,width:250,alt:o,role:"presentation"}):v.jsx(he,{})}),v.jsxs(we,{children:[v.jsxs(Oe,{children:[v.jsxs("p",{children:[o," ",v.jsx("span",{children:u}),", ",n]}),v.jsx("p",{children:r})]}),v.jsxs(ke,{children:[R," | ",i," | ",T," | ",l," | ",s," |"," ",p]})]})]}),v.jsx(pe,{children:"Learn more"})]})}me.propTypes={data:c.shape({id:c.number.isRequired,year:c.number.isRequired,make:c.string.isRequired,model:c.string.isRequired,type:c.string.isRequired,img:c.string,description:c.string,fuelConsumption:c.string,engineSize:c.string,accessories:c.arrayOf(c.string),functionalities:c.arrayOf(c.string).isRequired,rentalPrice:c.string.isRequired,rentalCompany:c.string.isRequired,address:c.string.isRequired,rentalConditions:c.string,mileage:c.number.isRequired}).isRequired};const Me=P.ul`
  display: grid;
...
`;P.h1`
  ...
  transition: var(--trans);
`;function ge({data:e}){return v.jsx(Me,{children:e.map(t=>v.jsx(me,{data:t},t.id))})}ge.propTypes={data:c.arrayOf(c.shape({id:c.number.isRequired,year:c.number.isRequired,make:c.string.isRequired,model:c.string.isRequired,type:c.string.isRequired,img:c.string,description:c.string,fuelConsumption:c.string,engineSize:c.string,accessories:c.arrayOf(c.string),functionalities:c.arrayOf(c.string).isRequired,rentalPrice:c.string.isRequired,rentalCompany:c.string.isRequired,address:c.string.isRequired,rentalConditions:c.string,mileage:c.number.isRequired}).isRequired).isRequired};function ze(){const{data:e,error:t,isLoading:o}=fe();return g.useEffect(()=>{t&&E.error(`An error occurred while receiving data: ${t}`)},[t]),v.jsxs(v.Fragment,{children:[o&&v.jsx(ye,{}),!o&&!t&&v.jsx(ge,{data:e})]})}export{ze as default};
