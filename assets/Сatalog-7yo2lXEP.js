...
`;function pe({onLoadMore:e}){return h.jsx(je,{onClick:e,children:"Load more"})}pe.propTypes={onLoadMore:V.func.isRequired};function me({data:e}){const{img:t,make:o,mileage:s,model:c,type:l,year:n,rentalPrice:r,address:E,rentalCompany:b,functionalities:y}=e,f=E.split(","),L=f[1].trim(),a=f[2]?f[2].trim():"",d=y[0];return h.jsxs(Ie,{children:[h.jsx(Ne,{}),h.jsxs("div",{children:[h.jsx(_e,{children:t?h.jsx("img",{src:t,width:250,alt:o,role:"presentation"}):h.jsx(ge,{})}),h.jsxs(we,{children:[h.jsxs(Oe,{children:[h.jsxs("p",{children:[o," ",h.jsx("span",{children:c}),", ",n]}),h.jsx("p",{children:r})]}),h.jsxs(Re,{children:[L," | ",a," | ",b," | ",l," | ",s," |"," ",d]})]})]}),h.jsx(pe,{children:"Learn more"})]})}me.propTypes={post:V.shape({id:V.number.isRequired,poster_path:V.string,title:V.string.isRequired}).isRequired};const Me=B.ul`
  display: grid;
