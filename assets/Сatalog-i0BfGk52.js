...
`;function re({title:e,handleLoadMore:t}){return h.jsx(Ne,{onClick:t,children:e})}re.propTypes={title:u.string.isRequired};const je=P.label`
  display: block;
  top: 14px;
  right: 14px;
  position: absolute;
